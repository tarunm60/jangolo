		 	    ...
		 	    $.ajax({
				  ...
				  //dataType:"json",
				   ...
				   beforeSend:function(jqXHR){
									   ...
									   var appendMe ='<div id="loginOverlay"></div><div id="loginpbar"></div>';
										var p =0;
										$('body').append(appendMe );
										
										var  $loading = $( "#loginpbar" );
										 $loading.progressbar({value:0});
												var timer = setInterval(function(){
											//This animates the bar
											$(".ui-progressbar-value").show(1);
											$(".ui-progressbar-value").animate({width: p+"%"}, 50);
											//This does static sets of the value
											//$loading.progressbar("option","value",p);
								
											p = p +10;
											if(p>100){
												$("#loginpbar .ui-progressbar-value").animate({width: "100%"}, 50);
