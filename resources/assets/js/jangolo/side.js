...
function styleList ()
	...
	{
		$.ajax({
					  url: '/index.php/tasks/tasks',
					  type:"POST",
					 // data:formData,
					  global:false,
					  success: function(data){
						//alert(data);
						$('#mytask').empty().append(data);
...
// Raoul this following code will animate our menu 

			/*	$('ul#menuDeroulant li ul li').hide();		   
				
				$('ul#menuDeroulant li').hover(function(){
										
										$(this).find('ul li').show();
										//$(this).find('ul').css("display","block");
										},
										
										function(){$(this).find('ul li').hide();
										}
										)	*/			
						   ...
						   $('#clicko_me').click(function()
							{
							 ...
							 //$('tr.row').live('mouseenter',function(){
//								 
...
//								 
//								 });
//								 $('tr.row').live('mouseleave',function(){
//								 
